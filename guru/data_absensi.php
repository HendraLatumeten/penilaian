...
>>>>>>> 960625800bbd2465d7e783f50fba8baaed67e1aa
session_start();
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        <li >
                            <a  href="home.php"><i class="notika-icon notika-house"></i> Home</a>
                        </li>
                        <li class="active" >
                            <a  href="absen_siswa.php"><i class="notika-icon notika-edit active"></i>Absen Siswa</a>
                        </li>
                        <li>
                            <a  href="nilai_siswa.php"><i class="notika-icon notika-form"></i>Nilai  Siswa</a>
                        </li>
                        <li>
                            <a  href="tugas_siswa.php"><i class="notika-icon notika-bar-chart"></i>Tugas Siswa</a>
                        </li>
                        <li>
                            <a  href="kegiatan_siswa.php"><i class="notika-icon notika-windows"></i>Kegiatan Siswa</a>
                        </li>
                       <!--  <li>
                            ...
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Hadir</td>
                                        <th>
                                            <button class="btn btn-primary orange-icon-notika btn-reco-mg btn-button-mg waves-effect"><i class="notika-icon notika-checked"></i></button>
                                        </th>
                                    </tr>
